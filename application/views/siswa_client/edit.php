        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <?php echo form_open_multipart('C_siswa_client/edit'); ?>
                            <?php echo form_hidden('kode',$siswa[0]->kode); ?>
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="nama" placeholder="Nama Here" value="<?php echo $siswa[0]->nama; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Email</label>
                                        <div class="col-sm-9">
                                            <input type="email" class="form-control" name="email" placeholder="email Here" value="<?php echo $siswa[0]->email; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="email1" class="col-sm-3 text-right control-label col-form-label">Nomor HP</label>
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="no_hp" placeholder="Nomor HP Here" value="<?php echo $siswa[0]->no_hp; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Mapel</label>
                                        <div class="col-sm-9">
                                            <textarea name="alamat" id="" cols="30" rows="3" class="form-control"><?php echo $siswa[0]->alamat; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
