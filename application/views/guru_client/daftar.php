        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <?php echo form_open_multipart('C_guru_client/daftar'); ?>
                            <?php echo form_hidden('kode',$guru[0]->kode); ?>
                                <div class="card-body">
                                    <h4 class="card-title">Form Penguruan</h4>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="nama" readonly="" placeholder="Nama Here" value="<?php echo $guru[0]->nama; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Email</label>
                                        <div class="col-sm-9">
                                            <input type="email" class="form-control" readonly="" name="email" placeholder="email Here" value="<?php echo $guru[0]->email; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="email1" class="col-sm-3 text-right control-label col-form-label">Nomor HP</label>
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" readonly="" name="no_hp" placeholder="Nomor HP Here" value="<?php echo $guru[0]->no_hp; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Mapel</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" readonly="" name="mapel" placeholder="Mapel Here" value="<?php echo $guru[0]->mapel; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
